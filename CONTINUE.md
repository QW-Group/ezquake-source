...
Atualizado em: 2026-08-05 (sessão Claude, Windows, `E:\Projetos Linux\ezquake-sdl3-vulkan-pr`, trabalho autônomo overnight autorizado por Tiago) — ver seção "Sessão 2026-08-05 (Claude, Windows — port SDL2→SDL3 finalizado + gaps Vulkan)" logo abaixo para o estado mais recente. As demais seções continuam válidas como histórico.
