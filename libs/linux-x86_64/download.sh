#!/bin/sh
wget 'http://ezquake.svn.sourceforge.net/viewvc/*checkout*/ezquake/trunk/libs/linux-x86_64/libexpat.a'
wget 'http://ezquake.svn.sourceforge.net/viewvc/*checkout*/ezquake/trunk/libs/linux-x86_64/libircclient.a'
