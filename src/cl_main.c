...
// The following strings are required to allow KTX to work properly.
#define KTX_COMMANDS 	"//at //authprompt //challenge //finalscores //ktx //mvdsv_ssw //qul //sn " \
			"//ucmd //wps //wvep bf changing cmd color fullserverinfo on_enter "        \
			"on_enter_ctf on_enter_ffa on_spec_enter on_spec_enter_ctf "                \
			"on_spec_enter_ffa packet play reconnect skin skins team"
static void CL_Set_KTX_f(void);

// stufftext restrictions
static void OnChange_stufftext_allowed_commands(cvar_t *var, char *string, qbool *cancel);
cvar_t cl_stufftext_allowed_commands = {
	"cl_stufftext_allowed_commands",
	"",
	0,
	OnChange_stufftext_allowed_commands
};
...
static void CL_InitLocal(void)
{
	...
	Cmd_AddCommand("set_ktx", CL_Set_KTX_f);
...
static void CL_Set_KTX_f(void)
{
	Com_Printf("Adapting client for KTX use.\n\n"
		"For security reasons servers are no longer allowed to push aliases and upload "
		"files to your computer.\n\n"
		"NOTE: votemap <map name> to change map\n");

	Cvar_Set(&cl_stufftext_allowed_commands, KTX_COMMANDS);

	// The list of aliases has been extracted from the ktx source code and
	// translated into tempaliases.
	Cbuf_AddTextEx(&cbuf_main, "tempalias +scores cmd +scores\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias -scores cmd -scores\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias +wp_stats cmd +wp_stats\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias -wp_stats cmd -wp_stats\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 10fav_go cmd 10fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 10on10 cmd 10on10\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 11fav_go cmd 11fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 12fav_go cmd 12fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 13fav_go cmd 13fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 14fav_go cmd 14fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 15fav_go cmd 15fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 16fav_go cmd 16fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 17fav_go cmd 17fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 18fav_go cmd 18fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 19fav_go cmd 19fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 1fav_go cmd 1fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 1on1 cmd 1on1 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 20fav_go cmd 20fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 2fav_go cmd 2fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 2on2 cmd 2on2 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 2on2on2 cmd 2on2on2 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 3fav_go cmd 3fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 3on3 cmd 3on3 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 3on3on3 cmd 3on3on3 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 4fav_go cmd 4fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 4on4 cmd 4on4 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 4on4on4 cmd 4on4on4 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 5fav_go cmd 5fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 6fav_go cmd 6fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 7fav_go cmd 7fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 8fav_go cmd 8fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias 9fav_go cmd 9fav_go\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias XonX cmd XonX %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias about cmd about\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias admin cmd admin %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias agree cmd agree\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias airstep cmd airstep\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias antilag cmd antilag\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias arena cmd arena\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias auto_pow cmd auto_pow\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias autotrack cmd autotrack\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias autotrackktx cmd autotrackktx\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ban cmd ban %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias banip cmd banip %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias banrem cmd banrem %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias berzerk cmd berzerk\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias blitz2v2 cmd blitz2v2 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias blitz4v4 cmd blitz4v4 %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias botcmd cmd botcmd %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias break cmd break\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias calltempalias cmd calltempalias\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias cam cmd cam\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias captain cmd captain\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias carena cmd carena %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias check cmd check %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias cm cmd cm\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias cmdslist_dl cmd cmdslist_dl\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias coach cmd coach\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias commands cmd commands %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias coop_nm_pu cmd coop_nm_pu\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ctf cmd ctf %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ctfbasedspawn cmd ctfbasedspawn\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias demomark cmd demomark\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dinfo cmd dinfo %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias discharge cmd discharge\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dlist cmd dlist %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dm cmd dm\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmgfrags cmd dmgfrags\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmm1 cmd dmm1\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmm2 cmd dmm2\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmm3 cmd dmm3\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmm4 cmd dmm4\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dmm5 cmd dmm5\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias downplayers cmd downplayers\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias downspecs cmd downspecs\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dropitem cmd dropitem %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias droppack cmd droppack\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dropquad cmd dropquad\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dropring cmd dropring\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias dumpent cmd dumpent %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias effi cmd effi\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias elect cmd elect\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias exclusive cmd exclusive\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fairpacks cmd fairpacks\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fallbunny cmd fallbunny\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav10_add cmd fav10_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav11_add cmd fav11_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav12_add cmd fav12_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav13_add cmd fav13_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav14_add cmd fav14_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav15_add cmd fav15_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav16_add cmd fav16_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav17_add cmd fav17_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav18_add cmd fav18_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav19_add cmd fav19_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav1_add cmd fav1_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav20_add cmd fav20_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav2_add cmd fav2_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav3_add cmd fav3_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav4_add cmd fav4_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav5_add cmd fav5_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav6_add cmd fav6_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav7_add cmd fav7_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav8_add cmd fav8_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav9_add cmd fav9_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav_add cmd fav_add\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav_all_del cmd fav_all_del\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav_del cmd fav_del\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav_next cmd fav_next\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fav_show cmd fav_show\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ffa cmd ffa %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias flagstatus cmd flagstatus\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias force_spec cmd force_spec %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias forcebreak cmd forcebreak\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias forcemap cmd forcemap %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias forcestart cmd forcestart\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fp cmd fp\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fp_spec cmd fp_spec\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fpslist cmd fpslist\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fragsdown cmd fragsdown\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fragsup cmd fragsup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias freeze cmd freeze\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias fresh cmd fresh\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias freshguns cmd freshguns\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias freshpacks cmd freshpacks\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias freshtime cmd freshtime\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias gamemodes cmd gamemodes\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias giveme cmd giveme %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias gren_mode cmd gren_mode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias handicap cmd handicap %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hdptoggle cmd hdptoggle\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hook_classic cmd hook_classic\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hook_crhook cmd hook_crhook\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hook_fast cmd hook_fast\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hook_smooth cmd hook_smooth\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias hoonymode cmd hoonymode %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias info cmd info\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias infolock cmd infolock\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias infospec cmd infospec\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias instagib cmd instagib\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias instagib_coilgun_kickback cmd instagib_coilgun_kickback\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias iplist cmd iplist\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias kick cmd kick\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias kill cmd kill\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias killer cmd killer\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias killquad cmd killquad\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias kinfo cmd kinfo %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias klist cmd klist\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound1 cmd ksound1\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound2 cmd ksound2\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound3 cmd ksound3\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound4 cmd ksound4\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound5 cmd ksound5\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ksound6 cmd ksound6\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias kuinfo cmd kuinfo %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias lastscores cmd lastscores %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias laststats cmd laststats\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias lgcmode cmd lgcmode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias list cmd list\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias lock cmd lock\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias lockmap cmd lockmap\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias lockmode cmd lockmode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mapcycle cmd mapcycle\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias maps cmd maps %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mapslist_dl cmd mapslist_dl\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mctf cmd mctf\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias midair cmd midair\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias midair_minheight cmd midair_minheight\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mkick cmd mkick %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias mmode cmd mmode %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias moreinfo cmd moreinfo\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias motd cmd motd\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias multi cmd multi %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias newcomer cmd newcomer\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias next_best cmd next_best\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias next_map cmd next_map\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias next_pow cmd next_pow\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias no cmd no\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias no_gl cmd no_gl\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias no_lg cmd no_lg\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias noga cmd noga\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias nohook cmd nohook\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias noitems cmd noitems\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias norunes cmd norunes\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias nospecs cmd nospecs\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias nosweep cmd nosweep\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias noweapon cmd noweapon %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias options cmd options\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias overtime cmd overtime\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias overtimeup cmd overtimeup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pause cmd pause\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pickspawn cmd pickspawn\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pickup cmd pickup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_angles cmd pos_angles %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_move cmd pos_move %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_origin cmd pos_origin %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_save cmd pos_save %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias pos_show cmd pos_show %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias powerups cmd powerups %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias powerups_pickup cmd powerups_pickup %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias practice cmd practice\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias prewar cmd prewar\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias qenemy cmd qenemy\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias qizmo cmd qizmo\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias qlag cmd qlag\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias qpoint cmd qpoint\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ra_break cmd ra_break\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ra_pos cmd ra_pos\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race cmd race\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_break cmd race_break\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_break_all cmd race_break_all\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_cancel cmd race_cancel\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_chasecam cmd race_chasecam\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_chasecam_freelook cmd race_chasecam_freelook\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_chasecam_view cmd race_chasecam_view\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_countdown_down cmd race_countdown_down\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_countdown_up cmd race_countdown_up\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_del_checkpoint cmd race_del_checkpoint\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_dl_record_demo cmd race_dl_record_demo %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_hide_players cmd race_hide_players\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_match cmd race_match\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_pacemaker cmd race_pacemaker %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_ready cmd race_ready\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_route_clear cmd race_route_clear\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_route_switch cmd race_route_switch\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_scoring cmd race_scoring\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_checkpoint cmd race_set_checkpoint\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_falsestart cmd race_set_falsestart %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_finish cmd race_set_finish\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_start cmd race_set_start\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_timeout cmd race_set_timeout %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_set_weapon_mode cmd race_set_weapon_mode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_show_lineup cmd race_show_lineup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_show_record_details cmd race_show_record_details %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_show_route cmd race_show_route\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_show_toptimes cmd race_show_toptimes\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_simultaneous cmd race_simultaneous\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias race_toggle cmd race_toggle\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias ready cmd ready\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias removeitem cmd removeitem %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias report cmd report\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias rnd cmd rnd %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias roundsdown cmd roundsdown\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias roundsup cmd roundsup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias rpickup cmd rpickup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias rules cmd rules\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-l cmd s-l\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-m cmd s-m\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-p cmd s-p\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-r cmd s-r\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias s-t cmd s-t\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias scores cmd scores\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias sct_hex cmd sct_hex\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias sct_oct cmd sct_oct\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias sh_speed cmd sh_speed\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias shownick cmd shownick %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias silence cmd silence\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias slowready cmd slowready\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias spawn cmd spawn\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias spawn666time cmd spawn666time %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias spawn_show cmd spawn_show\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias speed cmd speed\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias stats cmd stats\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias status1 cmd status1\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias status2 cmd status2\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias swapall cmd swapall\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias teamoverlay cmd teamoverlay\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias teleportcap cmd teleportcap %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias teleteam cmd teleteam\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time cmd time\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time10 cmd time10\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time15 cmd time15\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time20 cmd time20\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time25 cmd time25\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time30 cmd time30\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias time5 cmd time5\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias timedown cmd timedown\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias timedown1 cmd timedown1\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias timeup cmd timeup\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias timeup1 cmd timeup1\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tkfjump cmd tkfjump\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tkrjump cmd tkrjump\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias toggleready cmd toggleready\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tossflag cmd tossflag\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tossrune cmd tossrune\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tp cmd tp\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tpmsg cmd tpmsg %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias tracklist cmd tracklist\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias trx_play cmd trx_play\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias trx_rec cmd trx_rec\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias trx_stop cmd trx_stop\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias uinfo cmd uinfo\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias upplayers cmd upplayers\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias upspecs cmd upspecs\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias victim cmd victim\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias votecoop cmd votecoop\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias votemap cmd votemap %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias voteprivate cmd voteprivate\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias vwep cmd vwep\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias who cmd who\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias whonot cmd whonot\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias whoskin cmd whoskin\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias whovote cmd whovote\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias wipeout cmd wipeout %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias wp_reset cmd wp_reset\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias wreg cmd wreg %0\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias yawnmode cmd yawnmode\n");
	Cbuf_AddTextEx(&cbuf_main, "tempalias yes cmd yes\n");
}
