...
void GLM_PreRenderView(void)
{
	...
	// R_PolyBlend() already applies v_blend separately; this pass never blends.
	frameConstants.v_blend[0] = 0;
	frameConstants.v_blend[1] = 0;
	frameConstants.v_blend[2] = 0;
	frameConstants.v_blend[3] = 1;
