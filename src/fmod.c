...
// rerelease
static check_models_hashes_entry_t sound_doors_rerelease_airbut1 = { {0x47d5141e, 0xc925e8eb, 0x26e5583c, 0xc8dfd021, 0x226792ef}, NULL };
...
void FMod_Init (void)
{
	...
	FMod_AddModel ("sound/buttons/airbut1.wav",	FMOD_DM | FMOD_TF,	sound_buttons_airbut1_wav_FMOD_DM_FMOD_TF);
		...
		FMod_AddModelAlt(lastid, &sound_items_rerelease_airbut1);
