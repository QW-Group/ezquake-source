...
Foundation, Inc., 59 Temple Place - Suite 330, Boston, MA  02111-1307, USA.
	...
	$Id: gas2masm.c,v 1.4 2006-06-20 17:30:06 johnnycz Exp $
*/
//
	...
	for ( ;; )
	{
		...
		case LINE_DONE:
			if (!firsttoken && tokennum)
			{
				...
				{
					if (!_stricmp (tokens[0], parsedata[i].text))
					{
...
int main ()
{
	...
	printf ("; Generated by $Id: gas2masm.c,v 1.4 2006-06-20 17:30:06 johnnycz Exp $\n"
			"; Copyright (C) 1996-1997 Id Software, Inc.\n"
