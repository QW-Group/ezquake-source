...
$Id: cl_screen.c,v 1.111.2.10 2007-09-14 13:01:07 disconn3ct Exp $
*/
#include <time.h>
#include "quakedef.h"
#include "cl_screen.h"
...
cvar_t  scr_teaminfo_order       = {"scr_teaminfo_order", "%p%n %l‘ %a/%h %w", CVAR_ARCHIVE, OnChange_scr_clock_format};
