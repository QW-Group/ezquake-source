...
void CommonDraw_Init(void)
{
	...
	HUD_Register("tracking", NULL, "Shows the name of tracked player.",
		...
		"format", "Ôòáãëéîçº %t‘ %n, ÊÕÍÐ for next", //"Tracking: [team] name, JUMP for next", "Tracking:" and "JUMP" are brown with gold [] around team. default: "Tracking %t %n, [JUMP] for next"
		"scale", "1",
		NULL);
