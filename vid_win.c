...
cvar_t		_vid_default_mode = {"_vid_default_mode", "0", CVAR_ARCHIVE};			// Note that 0 is MODE_WINDOWED
cvar_t		_vid_default_mode_win = {"_vid_default_mode_win", "3", CVAR_ARCHIVE};	// Note that 3 is MODE_FULLSCREEN_DEFAULT
