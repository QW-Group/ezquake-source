...
void Framebuffer_Create (fb_t *fbs)
{
	...
	GL_Bind(fbs->texture);
	GL_TexParameterf(GL_TEXTURE0, GL_TEXTURE_2D, fbs->texture, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
//	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB8, fbs->width, fbs->height, 0, GL_RGB, GL_FLOAT, NULL);
	...
	GL_TexParameterf(GL_TEXTURE0, GL_TEXTURE_2D, fbs->texture, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    GL_TexParameterf(GL_TEXTURE0, GL_TEXTURE_2D, fbs->texture, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    GL_TexParameterf(GL_TEXTURE0, GL_TEXTURE_2D, fbs->texture, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
    GL_TexParameterf(GL_TEXTURE0, GL_TEXTURE_2D, fbs->texture, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
