...
mvd_wp_info_t mvd_wp_info[mvd_info_types] = {
	{AXE_INFO,"axe",IT_AXE,"axe", 0, 0, NULL, "&cf0f" },
	{SG_INFO,"sg",IT_SHOTGUN,"sg", 0, 0, NULL, "&cf0f" },
	{SSG_INFO,"ssg",IT_SUPER_SHOTGUN,"&cf0fssg&r", 0, 0, &tp_name_ssg, "&cf0f"},
	{NG_INFO,"ng",IT_NAILGUN,"&cf0fng&r", 0, 0, &tp_name_ng, "&cf0f" },
	{SNG_INFO,"sng",IT_SUPER_NAILGUN,"&cf0fsng&r", 0, 0, &tp_name_sng, "&cf0f" },
	{GL_INFO,"gl",IT_GRENADE_LAUNCHER,"&cf0fgl&r", 0, 0, &tp_name_gl, "&cf0f" },
	{RL_INFO,"rl",IT_ROCKET_LAUNCHER,"&cf0frl&r", MOD_ROCKETLAUNCHER, 0, &tp_name_rl, "&cf0f" },
	{LG_INFO,"lg",IT_LIGHTNING,"&cf0flg&r", MOD_LIGHTNINGGUN, 0, &tp_name_lg, "&cf0f" },
	{RING_INFO,"ring",IT_INVISIBILITY,"&cff0ring&r", MOD_RING, 0, &tp_name_ring, "&cff0" },
	{QUAD_INFO,"quad",IT_QUAD,"&c00fquad&r", MOD_QUAD, 0, &tp_name_quad, "&c00f" },
	{PENT_INFO,"pent",IT_INVULNERABILITY,"&cf00pent&r", MOD_PENT, 0, &tp_name_pent, "&cf00" },
	{GA_INFO,"ga",IT_ARMOR1,"&c0f0ga&r", MOD_ARMOR, 0, &tp_name_ga, "&c0f0" },
	{YA_INFO,"ya",IT_ARMOR2,"&cff0ya&r", MOD_ARMOR, 1, &tp_name_ya, "&cff0" },
	{RA_INFO,"ra",IT_ARMOR3,"&cf00ra&r", MOD_ARMOR, 2, &tp_name_ra, "&cf00" },
	{MH_INFO,"mh",IT_SUPERHEALTH,"&c00fmh&r", MOD_MEGAHEALTH, 0, &tp_name_mh, "&c00f" },
};
