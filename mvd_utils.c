...
mvd_wp_info_t mvd_wp_info[mvd_info_types] = {
	{AXE_INFO,"axe",IT_AXE,"axe","axe", 0, 0, NULL, "&cf0f", false, false },
	{SG_INFO,"sg",IT_SHOTGUN,"sg","sg", 0, 0, NULL, "&cf0f", false, false },
	{SSG_INFO,"ssg",IT_SUPER_SHOTGUN,"&cf0fssg&r", "&cf0fssg pack&r", 0, 0, &tp_name_ssg, "&cf0f", false, false },
	{NG_INFO,"ng",IT_NAILGUN,"&cf0fng&r", "&cf0fng pack&r", 0, 0, &tp_name_ng, "&cf0f", false, false },
	{SNG_INFO,"sng",IT_SUPER_NAILGUN,"&cf0fsng&r", "&cf0fsng pack&r", 0, 0, &tp_name_sng, "&cf0f", false, false },
	{GL_INFO,"gl",IT_GRENADE_LAUNCHER,"&cf0fgl&r", "&cf0fgl pack&r", 0, 0, &tp_name_gl, "&cf0f", false, false },
	{RL_INFO,"rl",IT_ROCKET_LAUNCHER,"&cf0frl&r", "&cf0frl pack&r", MOD_ROCKETLAUNCHER, 0, &tp_name_rl, "&cf0f", true, false },
	{LG_INFO,"lg",IT_LIGHTNING,"&cf0flg&r", "&cf0flg pack&r", MOD_LIGHTNINGGUN, 0, &tp_name_lg, "&cf0f", true, false },
	{RING_INFO,"ring",IT_INVISIBILITY,"&cff0ring&r", "", MOD_RING, 0, &tp_name_ring, "&cff0", true, true },
	{QUAD_INFO,"quad",IT_QUAD,"&c00fquad&r", "", MOD_QUAD, 0, &tp_name_quad, "&c44f", true, true },
	{PENT_INFO,"pent",IT_INVULNERABILITY,"&cf00pent&r", "", MOD_PENT, 0, &tp_name_pent, "&cf44", true, true },
	{GA_INFO,"ga",IT_ARMOR1,"&c0f0ga&r", "", MOD_ARMOR, 0, &tp_name_ga, "&c0f0", true, false },
	{YA_INFO,"ya",IT_ARMOR2,"&cff0ya&r", "", MOD_ARMOR, 1, &tp_name_ya, "&cff0", true, false },
	{RA_INFO,"ra",IT_ARMOR3,"&cf00ra&r", "", MOD_ARMOR, 2, &tp_name_ra, "&cf00", true, false },
	{MH_INFO,"mh",IT_SUPERHEALTH,"&c00fmh&r", "", MOD_MEGAHEALTH, 0, &tp_name_mh, "&c7ff", true, false },
};
