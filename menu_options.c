...
setting settbinds_arr[] = {
	...
	ADDSET_SEPARATOR("Attack"),
	ADDSET_BIND("Fire Selected Weapon", "+attack"),
	ADDSET_BIND("Primary Grenade", "gren1"),
	ADDSET_BIND("Secondary Grenade", "gren2"),
	ADDSET_BIND("Quick Primary Attack", "+slot1"),
	ADDSET_BIND("Quick Secondary Attack", "+slot2"),
	ADDSET_BIND("Quick Tertiary Attack", "+slot3"),
	ADDSET_BIND("Quick Melee Attack", "+slot4"),
	ADDSET_ADVANCED_SECTION(),
	ADDSET_BIND("Prime Primary Grenade", "primeone"),
	ADDSET_BIND("Prime Secondary Grenade", "primetwo"),
	ADDSET_BIND("Throw Grenade", "throwgren"),
	ADDSET_BASIC_SECTION(),

	ADDSET_SEPARATOR("Actions"),
	ADDSET_BIND("Class Menu", "menu"),
	...
	ADDSET_BIND("Inventory", "inv"),

	ADDSET_SEPARATOR("World"),
	ADDSET_BIND("Flag Info", "flaginfo"),
	ADDSET_BIND("Map Help", "maphelp"),
