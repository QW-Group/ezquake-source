...
// SSBO bindings
#define EZQ_GL_BINDINGPOINT_ALIASMODEL_SSBO     0
#define EZQ_GL_BINDINGPOINT_WORLDMODEL_SURFACES 1
#define EZQ_GL_BINDINGPOINT_ALIASMODEL_DRAWDATA 2
#define EZQ_GL_BINDINGPOINT_WORLDMODEL_DRAWDATA 3

// UBO bindings
#define EZQ_GL_BINDINGPOINT_FRAMECONSTANTS      0
#define EZQ_GL_BINDINGPOINT_DRAWWORLD_CVARS     1
